...
public class RecordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        game_index.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!game_index_state) {
                    ...
                    game_recycler_view.setVisibility(View.VISIBLE);
                    user_recycler_view.setVisibility(View.INVISIBLE);
                    score_recycler_view.setVisibility(View.INVISIBLE);
        ...
        user_index.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!user_index_state) {
                    ...
                    game_recycler_view.setVisibility(View.INVISIBLE);
                    score_recycler_view.setVisibility(View.INVISIBLE);
        ...
        score_index.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!score_index_state) {
                    ...
                    score_index_state = !score_index_state;
                    score_recycler_view.setVisibility(View.VISIBLE);
                    game_recycler_view.setVisibility(View.INVISIBLE);
                    user_recycler_view.setVisibility(View.INVISIBLE);
        ...
        user_adapter.addItem(new UserItem("Gabe", 31, "♂", 4, 0));
        user_adapter.addItem(new UserItem("June", 30, "♂", 0, 4));
        user_adapter.addItem(new UserItem("Julia", 23, "♀", 2, 2));
        ...
        score_adapter.addItem(new ScoreItem("2022-10-18", "Nowee", "Ann", 3, 1));
